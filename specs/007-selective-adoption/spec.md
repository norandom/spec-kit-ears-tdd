...
- REQ-002: Where a project declares no check configuration, the validator shall run every check.
...
- SC-003: An existing project that adds no configuration observes no change in findings.
